...
final <- combined_data$date < as.POSIXct('2015-11-12 00:00:00', 
                                   '%Y-%m-%d %H:%M:%S', 
                                   tz = 'Asia/Kuala_Lumpur')

#### Month and year classification ####
Month_class <- NA 
for (i in 1:nrow(combined_data)) {if  (combined_data$date[i] > as.POSIXct('2015-11-12 00:00:00',
                                           '%Y-%m-%d %H:%M:%S',
                                           tz = 'Asia/Kuala_Lumpur') &
    combined_data$date[i] < as.POSIXct('2015-11-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Nov2015'
  }
  if (combined_data$date[i] > as.POSIXct('2015-11-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2015-12-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Dec2015'
  }
  if (combined_data$date[i] > as.POSIXct('2015-12-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$datep[i] < as.POSIXct('2016-01-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Jan2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-01-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-02-29 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Feb2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-02-29 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-03-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
  ...
  if (df$time_stamp[i] > as.POSIXct('2016-03-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-04-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Apr2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-04-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-05-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'May2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-05-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-06-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Jun2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-06-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-07-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Jul2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-07-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-08-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Aug2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-08-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-09-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Sep2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-09-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-10-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Oct2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-10-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-11-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Nov2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-11-30 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2016-12-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
    Month_class[i] <- 'Dec2016'
  }
  if (combined_data$date[i] > as.POSIXct('2016-12-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur') &
      combined_data$date[i] < as.POSIXct('2017-01-31 23:30:00',
                                    '%Y-%m-%d %H:%M:%S',
                                    tz = 'Asia/Kuala_Lumpur')){
